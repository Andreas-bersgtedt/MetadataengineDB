CREATE PROCEDURE [ME_Data].[sp_ADFGetSQLConfig]
(
@DataSetType VARCHAR(100),@RunGroupCode VARCHAR(20)
)
AS
BEGIN
...
SELECT	d.[DataSetType], 
      ...
      ,SQLQuery=CONVERT(NVARCHAR(MAX),'SELECT '+[ME_Config].[fnGetRMDBSQuerySelectColumnNames](E.Id)+' FROM ['+E.[SchemaName]+'].['+E.[Name]+']')
